...
<html lang="en">
  <head>
    <title>ETEC &mdash; SUPORTE ETIM</title>
    <meta charset="utf-8">
  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="index.html" class="h2 mb-0">Life<span>Coach</span></a></h1>
          </div>
          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li><a href="#services-section" class="nav-link">Curso</a></li>
    ...
    <div class="site-blocks-cover overlay" style="background-image: url(images/Etec-ilhasolteira.jpg);" data-aos="fade" id="home-section">
      <div class="container">
        <div class="row">

          <div class="col-md-6 mt-lg-5 ml-auto text-left align-self-end align-self-md-center">
            <h1>AUXÍLIO PROFISSIONAL EM TÉCNICO DE DESENVOLVIMENTO DE SISTEMAS</h1>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 col-lg-4 mb-4 mb-lg-0">
            <h2 class="text-white">Vantagens</h2>
          </div>
          <div class="col-md-6 col-lg-4 d-flex">
            <div class="mr-3"><span class="flaticon-bill display-3 text-special"></span></div>
            <div>
              <h3 class="text-white h4">Suporte 100% disponibilizado por alunos a partir do curso</h3>
              <p class="text-special">É necessário que estejam atentos as disciplinagens, que atuam no currículo</p>
      ...
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-lg-6 order-md-1" data-aos="fade">
            <h2 class="section-title mb-3">Conheça nosso suporte</h2>
  ...
  -->
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-lg-7 text-left">
            <h2 class="section-title mb-3">Desenvolvedores</h2>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 mb-4">
            <div class="team-member">
              <figure>
                <ul class="social">
                  <li><a href="https://www.instagram.com/baianinhokkkk/" target="_blank"><span class="icon-instagram"></span></a></li>
                  <li><a href="https://www.linkedin.com/in/felipe-costa-20a12b262/" target="_blank"><span class="icon-linkedin"></span></a></li>
                </ul>
                <img src="images/person_5.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="p-3">
                <h3>Felipe Costa</h3>
                <span class="position">Programador Frontend</span>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 mb-4">
            <div class="team-member">
              <figure>
                <ul class="social">
                  <li><a href="https://www.instagram.com/g.jhony_/" target="_blank"><span class="icon-instagram"></span></a></li>
      ...
      <div class="container">
        ...
        <div class="row mb-5">
          <div class="col-12 text-center">
            ...
            <p class="section-title mb-3 services-sub-title">Desenvolvimento Web</p>
          </div>
        </div>
    ...
    <section class="site-section testimonial-wrap" id="testimonials-section" style="background-color: white;">
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center">
            <h2 class="section-title mb-3">Testemunhos</h2>
          </div>
        </div>
      </div>
          ...
          <div>
            <div class="testimonial">
              ...
              <blockquote class="mb-5">
                <p>&ldquo;Me gratifico em dizer que a programação foi o ponto chave para unir meus objetivos ao agradável. Meus propósitos no mercado de trabalho estavam em falta
                  até eu criar algo que posso chamar de minha empresa.&rdquo;</p>
              </blockquote>
    ...
    <section class="site-section" id="blog-section" style="background-color: white;">
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center">
    ...
    <section class="site-section bg-dark" id="contact-section"  style="color: white;">
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center">
            <h2 class="section-title mb-3"  style="color: white;">Reach to us</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4">
            <p class="mb-0 font-weight-bold">Address</p>
            <p class="mb-4">Rua dos Andradas, 140 - Santa Ifigênia
              CEP 01208-000 – São Paulo – SP</p>
          </div>
          <div class="col-md-4">
            <p class="mb-0 font-weight-bold">Phone</p>
            <p class="mb-4"><a>+55 11 3324-3300</a></p>
          </div>
          <div class="col-md-4">
            <img src="images/Icons/time-icon.png" width="18"> <br>
            <p class="mb-0"><a>Seg. a Sex. das 08h às 17h</a></p>
          </div>
        </div>
        <div class="row">
